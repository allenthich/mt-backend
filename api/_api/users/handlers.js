...
const service_1 = require("../../_api/users/service");
const getUserByUserId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield service_1.usersService.getUser(req.params.id);
...
const updateUserByUserId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield service_1.usersService.updateUser(req.params.id, req.body);
        return res.status(http_status_codes_1.StatusCodes.OK).json(user);
    }
    catch (e) {
        next(e);
...
const deleteUserByUserId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield service_1.usersService.deleteUser(req.params.id);
        return res.status(http_status_codes_1.StatusCodes.OK).json(user);
    }
    catch (e) {
        next(e);
